...
\noindent {\bf Stage 1:} Design and introduce two new courses \statcl, \astrocl,
...
\noindent {\bf Stage 3:} 
%Incorporate feedback from evaluators and all participants. Continue developing the courses' %software and data infrastructure. 
Investigate if the two new courses could be
