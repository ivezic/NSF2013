...
{\em Stage 1:} Design and introduce two new courses \statcl, \astrocl,
...
However, for reasons we will expound later (\ref{sec:python}, we
...
by AMATH ({\sc 481} (project based, in Matlab) {\sc 482, 483}). Our
